...
static int initialHit[] = new int[2];
    ...
    while (userTurn == false){
        if (lastShot == false){
          ...
          x = r.nextInt(10) ; //computers random shot x-cor
          y = r.nextInt(10) ; //computers random shot y-cor
         ...
         // x = r.nextInt(10) + 1; //computers random shot x-cor
          ...
          case 0:  if ( Hit(prevHit[0], prevHit[1] + 1) == true && board[prevHit[0]][prevHit[1]+ 1 ] == false){ //hit right after hitting once
                    ...
                    directionHit = 4; //shoot right next time
                    userTurn = true;
                    board[prevHit[0]][ prevHit[1]] = true;
                    System.out.println("Hit x = "  + prevHit[0] + " y = " + prevHit[1]);
                    if (sunkShip()){
                        lastShot = false;
                    ...
                    lastShot = true;
                    userTurn = true;
                    System.out.println("MISS x = " + prevHit[0] + " y = " + (prevHit[1] + 1));
                    directionHit = 1; //shoot above next time
                    }
          ...
          case 1:  if ( Hit(prevHit[0] - 1 , prevHit[1]) == true && board[prevHit[0] - 1][prevHit[1]] == false){ //hit above after hitting once
                    ...
                    prevHit[1] = prevHit[1] ;
                    directionHit = 5; //shoot up next time
                    userTurn = true;
                    board[prevHit[0]][prevHit[1]] = true;
                    System.out.println("Hit x = "  + prevHit[0] + " y = " + prevHit[1]);
                    if (sunkShip()){
                     ...
                     directionHit = 2; //shoot left of hit next time
                      System.out.println("MISS x = " + (prevHit[0] - 1) + " y = " + prevHit[1]);
                   }
          ...
          case 2:  if ( Hit(prevHit[0]  , prevHit[1] - 1) == true && board[prevHit[0]][prevHit[1] - 1] == false){// hit left of initial hit
                    ...
                    prevHit[0] = prevHit[0];
                    prevHit[1] = prevHit[1] -1 ;
                    directionHit = 6; //shoot up next time
                    userTurn = true;
                    board[prevHit[0]][prevHit[1]] = true;
                    System.out.println("Hit x = "  + prevHit[0] + " y = " + prevHit[1]);
                    if (sunkShip()){
          ...
          case 3: if ( Hit(prevHit[0] + 1  , prevHit[1]) == true && board[prevHit[0] + 1][prevHit[1]] == false){// hit below initial hit
                    ...
                    prevHit[0] = prevHit[0] + 1;
                    prevHit[1] = prevHit[1] ;
                    directionHit = 7; //shoot below next time
                    userTurn = true;
                    board[prevHit[0]][prevHit[1]] = true;
                    System.out.println("Hit x = "  + prevHit[0] + " y = " + prevHit[1]);
                    if (sunkShip()){
                   ...
                   break;
          case 4: if ( Hit(prevHit[0], prevHit[1] + 1) == true && board[prevHit[0]][prevHit[1]+ 1 ] == false){ //hit right after hitting once
                    lastShot = true;
                    prevHit[0] = prevHit[0];
                    prevHit[1] = prevHit[1] + 1;
                    directionHit = 4; //shoot right next time
                    ...
                    if (sunkShip()){
                     ...
                     userTurn = true;
                     lastShot = true;
                     prevHit[0] = initialHit[0];
                     prevHit[1] = initialHit[1];
                     System.out.println("MISS x = "  + prevHit[0] + " y = " + prevHit[1]);
                     
                    
          }
              break;
          case 5:
              if ( Hit(prevHit[0] - 1 , prevHit[1]) == true && board[prevHit[0] - 1][prevHit[1]] == false){ //hit above after hitting once
                    lastShot = true;
                    prevHit[0] = prevHit[0] - 1;
                    prevHit[1] = prevHit[1] ;
                    directionHit = 5; //shoot up next time
              ...
              break;
          case 6:if ( Hit(prevHit[0]  , prevHit[1] - 1) == true && board[prevHit[0]][prevHit[1] - 1] == false){// hit left of initial hit
                    //System.out.println("HIT!!!");
                    lastShot = true;
                    prevHit[0] = prevHit[0];
                    prevHit[1] = prevHit[1] -1 ;
          ...
          case 7:if ( Hit(prevHit[0] + 1  , prevHit[1]) == true && board[prevHit[0] + 1][prevHit[1]] == false){// hit below initial hit
                    //System.out.println("HIT!!!");
                    lastShot = true;
                    prevHit[0] = prevHit[0] + 1;
                    prevHit[1] = prevHit[1] ;
    ...
    switch(sunkk){
        ...
        case 3:  sunk[2]=true;
                 System.out.println("sunk cruiser!");
                            break;
        case 4:  sunk[3]=true;
                 System.out.println("sunk destroyer1!");
                            break;
        case 5:  sunk[4]=true;
                 System.out.println("sunk destroyer2!");
                            break;
        case 6:  sunk[5]=true;
                 System.out.println("sunk submarine1!");
                            break;
        case 7:  sunk[6]=true;
                 System.out.println("sunk submarine2!");
                            break;
        default: 
                            break;
    }
